...
% nifti mask for cluster based permutation testing (if specified)
% perm - number of permutations for cluster based testing
% avout - flag set to 0 or 1 to determine if you output 95% thresholded
% images of X and Y
...
if exist('avout','var') && isequal(avout,1)
    avX = mean(XX,2);
    avY = mean(YY,2);
