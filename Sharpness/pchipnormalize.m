%function [ndata,a]=hermitenormalize(data)
 
% The function HERMITENORMALIZE normalizes with cubic hermite interpolation (pchip),
...
%           6.cubic Hermite spline interpolation for the envelope-AM
...
%6.cubic Hermite spline interpolation for the envelope-AM 
        %find cubic Hermite spline envelope as AM                   
        a(:,c)=pchip(tx,mx,te);
